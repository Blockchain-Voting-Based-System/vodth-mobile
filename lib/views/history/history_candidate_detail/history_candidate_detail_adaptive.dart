part of 'history_candidate_detail_view.dart';

class _HistoryCandidateDetailAdaptive extends StatelessWidget {
  const _HistoryCandidateDetailAdaptive(this.viewModel);

  final HistoryCandidateDetailViewModel viewModel;

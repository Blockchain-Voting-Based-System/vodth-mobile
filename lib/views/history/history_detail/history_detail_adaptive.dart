...
class _HistoryDetailAdaptive extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: viewModel.event?.isPublic == true
            ? _buildStartVotingButton(context)
            : null,
      ),
    );
  }
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  Uri uri = Uri.parse(
                      'https://testnet.suivision.xyz/object/${viewModel.event?.suiEventId}');
                  await launchUrl(
                    uri,
  ...
  GestureDetector _buildCandidate(
      BuildContext context, CandidateModel candidate) {
    return GestureDetector(
      onTap: () {
        context.pushRoute(
          HistoryCandidateDetailRoute(id: candidate.id),
        );
      },
      child: Card(
